...
var videiocon = document.querySelector("#vedio-container")
var playbtn = document.querySelectorAll("#play")
videiocon.addEventListener("mouseenter",function(){
    gsap.to(playbtn,{
        scale:1,
        opacity:1
    })
...
videiocon.addEventListener("mouseleave",function(){
    gsap.to(playbtn,{
        scale:0,
        opacity:0
    })
...
videiocon.addEventListener("mousemove",function(dets){
    gsap.to(playbtn,{
        left:dets.x-70,
        top:dets.y-8
    })
...
// document.querySelectorAll(".chlid")
